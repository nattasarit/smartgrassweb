      ...
      <div id='content'>
        <div class='panel panel-default grid'>
          ...
          <div class='panel-body filters'>
            <div class='row'>
              <div class='col-md-9'>
                            เพิ่มข้อมูล <a href="addInstallationRate.php"><img src="assets/images/add.png" align="middle" height="42" width="42" > </a>
              </div>
              <div class='col-md-3'>
              ...
              <tr class='success'>
                ...
                <td class='action'>
                 <!-- <a class='btn btn-success' data-toggle='tooltip' href='#' title='Zoom'>
                  ...
                  <a class='btn btn-info' href='editInstallationRate.php'>
                    <i class='icon-edit'></i>
                  </a>
                  <a class='btn btn-danger' href='removeInstallationRate.php'>
