              ...
              <fieldset>
                <legend>กรุณากรอกข้อมูล</legend>
                 <div class='form-group'>
                  ...
                  <div class='col-lg-10'>
                  <input class='form-control'  disabled placeholder='ประเภทพาหนะ' type='text'>
					</div>
					<label class='col-lg-2 control-label'>ความจุ (เมตร)</label>
                  <div class='col-lg-10'>
                    <input class='form-control' disabled placeholder='ความจุ (เมตร)' type='text'>
                  </div>
				  <label class='col-lg-2 control-label'>ความจุ (ม้วน)</label>
                  <div class='col-lg-10'>
                    <input class='form-control' disabled placeholder='ความจุ (ม้วน)' type='text'>
                  </div>
				<label class='col-lg-2 control-label'>อัตราค่าขนส่ง</label>
                  <div class='col-lg-10'>
                    <input class='form-control' disabled placeholder='อัตราค่าขนส่ง' type='text'>
                  </div>
                </div>
