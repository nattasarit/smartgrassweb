              ...
              <fieldset>
                <legend>กรุณากรอกข้อมูล</legend>
                   <div class='form-group has-warning'>
			        <label class='col-lg-2 control-label'>รหัสสถานะงาน</label>
                  <div class='col-lg-10'>
                  <input class='form-control'  disabled placeholder='รหัสสถานะงาน' type='text'>
					</div>
				 <label class='col-lg-2 control-label'>ชื่อสถานะงาน</label>
                  <div class='col-lg-10'>
                  <input class='form-control' placeholder='ชื่อสถานะงาน' type='text'>
					</div>
                </div>
