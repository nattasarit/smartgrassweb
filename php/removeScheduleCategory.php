              ...
              <fieldset>
                <legend>กรุณากรอกข้อมูล</legend>
                 <div class='form-group'>
                       <label class='col-lg-2 control-label'>รหัสประเภทนัดหมาย</label>
                  <div class='col-lg-10'>
                  <input class='form-control'  disabled placeholder='รหัสประเภทนัดหมาย' type='text'>
					</div>
				 <label class='col-lg-2 control-label'>ชื่อประเภทนัดหมาย</label>
                  <div class='col-lg-10'>
                  <input class='form-control' disabled placeholder='ชื่อประเภทนัดหมาย' type='text'>
					</div>
                </div>
