              ...
              <fieldset>
                <legend>กรุณากรอกข้อมูล</legend>
                   <div class='form-group has-warning'>
				      <label class='col-lg-2 control-label'>รหัสวัสดุ</label>
                  <div class='col-lg-10'>
                    <input class='form-control' disabled placeholder='รหัสวัสดุ' type='text'>
                      <label class='col-lg-2 control-label'>ชื่อวัสดุ</label>
                  <div class='col-lg-10'>
                    <input class='form-control' placeholder='ชื่อวัสดุ' type='text'>
                  </div>
