            ...
            <form class='form-horizontal'>
              <fieldset>
                ...
                <div class='form-group has-warning'>
                  <label class='col-lg-2 control-label'>ลักษณะพื้นผิว</label>
                  <div class='col-lg-10'>
                  <input class='form-control' placeholder='ลักษณะพื้นผิว' type='text'>
					</div>
					<label class='col-lg-2 control-label'>ราคา</label>
                  <div class='col-lg-10'>
                    <input class='form-control' placeholder='ราคา' type='text'>
                  </div>
